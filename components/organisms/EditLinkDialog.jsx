            ...
            <form onSubmit={onSubmit} className="space-y-4 pt-4">
                <div className="space-y-2">
                    <Label className="text-muted-foreground">
                        {entityLabel}: <span className="text-foreground">{entityName}</span>
                    </Label>
                    <Input placeholder="https://..." value={link} onChange={(e) => onLinkChange(e.target.value)} className="border-border bg-surface-2" />
                </div>
